                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <a  href="<?php echo base_url().'company/deleteCompany/'.$record->id; ?>" title="Delete"><button type="button" class="btn btn-sm btn-danger" onclick="if(!confirm('Are you sure you want to delete this company?')){return false;}"><i class="fa fa-trash"></i></button></a>
                      </td>
                    </tr>
                    <?php
                        }
